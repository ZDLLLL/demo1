...
public class SearchCompanyEEAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<SearchBean.search> searchList;
    private EnrollActivity enrollActivity;
    public SearchCompanyEEAdapter(List<SearchBean.search> searchList, EnrollActivity enrollActivity) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        holder.searchcompany_item_ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                enrollActivity.ee_company_et.setText(holder.searchcompany_tv.getText());
