...
//                                bgView.setVisibility(View.VISIBLE);
    ...
    private void showAnimation(ViewGroup layout) {
        try {
            RelativeLayout linearLayout = layout.findViewById(R.id.lin);
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    //＋ 旋转动画
...
//                        bgView.setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.add_goodsclass_rl:
                v.getContext().startActivity(new Intent(v.getContext(), AddGoodsClassActivity.class));
                break;
            case R.id.staff_manage_rl:
                v.getContext().startActivity(new Intent(v.getContext(), StaffManagementActivity.class));
                break;
            case R.id.job_rl:
                v.getContext().startActivity(new Intent(v.getContext(), AddJobActivity.class));
                break;
            case R.id.check_rl:
                v.getContext().startActivity(new Intent(v.getContext(), CheckActivity.class));
                break;
