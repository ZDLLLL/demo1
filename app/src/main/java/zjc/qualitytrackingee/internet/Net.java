...
public class Net {
    ...
    public final  static String HEAD4="http://i3c8x94lqb.51http.tech/QianLiZhuiZong/";//316服务器
    ...
    public final  static String GetAllUserFeedBack=HEAD4+"getAllFeedbackBycid";//获得所有的用户反馈
    public final  static String GetUser=HEAD4+"GetAllPersonInfo";//获得所有的用户反馈
    public final  static String UploadMessage=HEAD4+"getCommodityByClass";//修改头像
...
//
//    public final  static String LOGIN=STUDENT+"FirstLogin";//登录
//    public final static String ENROLL=STUDENT+"registered";//企业注册
//    public final static String Search = STUDENT+"/Search";//公司搜索框
//    public final  static String AllCompany=STUDENT+"GetAllCompany";//登录
//    public final  static String CHANGE_PASSWD=STUDENT+"changePassword";//修改密码
//    public final  static String TextLogin=STUDENT+"FirstLoginM";//短信验证登录
//    public final  static String CheckEmployee=STUDENT+"AdminAudit";//员工审核列表
//    public final  static String AgreeCheckEmployee=STUDENT+"AdminAuditRes";//同意
//    public final  static String DisAgreeCheckEmployee=STUDENT+"AdminAuditRes";//不同意
//    public final  static String GetEmployee=STUDENT+"GetAllEmpBySC";//员工列表
//    public final  static String UploadGoods=STUDENT+"addCommodity";//上传产品信息
//    public final  static String GetAllGoodsClass=STUDENT+"getAllCommodityClassByCid";//获得所有商品类
//    public final  static String UploadGoodsClass=STUDENT+"addCommodityClass";//上传商品类
//    public final  static String DeleteGoodsClass=STUDENT+"deleteCommodityClass";//删除某个商品类
//    public final  static String GetAllJob=STUDENT+"GetAllJobByCid";//获得所有职务类
//    public final  static String UploadJob=STUDENT+"addJobBycid";//上传职务类
//    public final  static String DeleteJob=STUDENT+"deleteJob";//删除某个职务
//    public final  static String GetAllUserFeedBack=STUDENT+"GetAllUserFeedBack";//获得所有的用户反馈
//    public final  static String GetUser=STUDENT+"GetAllPersonInfo";//获得所有的用户反馈
//
//    public final  static String GetAllGoods=STUDENT+"getAllCommodityByCid";//获得所有商品类
//    public final  static String GetAllGoodsbyGoodsName=STUDENT+"getAllCommodityByCid";//获得所有商品类
